---
title: "NSAIDs patients using Eunomia"
author: "Carmen Ng"
...
On average, patients took `r comma(mean(drug_n$count))` medications.

#### Table 2. NSAIDs used in patients

```{r}
 drug_nsaid <- drug %>% distinct(PERSON_ID, DRUG_NAME) %>%
...
There were `r length(unique(obs$PERSON_ID))` patients in the OBSERVATION dataset. Below is a table of their previous allergies.
...
#### Table 4. Conditions of patients using NSAIDs at baseline
...
#### Table 5. Conditions post-index in patients using NSAIDs
